...
class AzureSpeechRecognitionServices {
  static const MethodChannel _channel =
  MethodChannel('azure_speech_recognition');

  static final AzureSpeechRecognitionServices _azureSpeechRecognition =
  AzureSpeechRecognitionServices._internal();

  factory AzureSpeechRecognitionServices() => _azureSpeechRecognition;
  ...
  AzureSpeechRecognitionServices.initialize(String subKey, String region,
  ...
  Future _platformCallHandler(MethodCall call) async {
    switch (call.method) {
      ...
      case "speech.onException":
        ...
        break;
      default:
        debugPrint("Error: method called not found");
    }
  }
