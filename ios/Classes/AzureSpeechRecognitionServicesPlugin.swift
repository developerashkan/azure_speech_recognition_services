...
public class AzureSpeechRecognitionServicesPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance: AzureSpeechRecognitionServicesPlugin = AzureSpeechRecognitionServicesPlugin(azureChannel: channel)
    ...
    private func stopContinuousStream(flutterResult: FlutterResult) {
        if (continuousListeningStarted) {
            ...
            do {
                ...
                print("Error occurred stopping continuous recognition")
            }
        }
    }
